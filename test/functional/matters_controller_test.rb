...
class MattersControllerTest < ActionController::TestCase
  ...
  test "should create matter" do
    assert_difference('Matter.count') do
      post :create, matter: { client_id: @matter.client_id, description: @matter.description, name: @matter.name, rate: @matter.rate }
    end
  ...
  test "should update matter" do
    put :update, id: @matter, matter: { client_id: @matter.client_id, description: @matter.description, name: @matter.name, rate: @matter.rate }
    assert_redirected_to matter_path(assigns(:matter))
  end
